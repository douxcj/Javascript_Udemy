...
// Associativity: assignment operator works from right-to-left
 ...
 */
 ...
 // == data type do not have to match
 // Equality operators
 if (height == '23') {
...
var whatDoYouDo = function(job, firstName) {
    switch(job) {
        case 'teacher':
            ...
            // immedietely exit, do not need to break
        case 'driver':
...
console.log(john.indexOf(1990)); // return -1 if not exist
...
if (john.average > mark.average) {
    console.log(john.fullName + ' \'s familt pays higher tips with an average of $ ' +john.average);
} else {
    console.log(mark.fullName + ' \'s familt pays higher tips with an average of $ ' +mark.average);
}